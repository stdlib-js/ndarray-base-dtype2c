...
```javascript
dtype2c = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-dtype2c@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-dtype2c@umd/bundle.js"></script>
```
